...
public:
  ...
  virtual void SendRrcIGMPRequest (RrcIGMPRequest msg) = 0;//yen
...
public:
  ...
  virtual void RecvRrcIGMPRequest (uint16_t rnti, RrcIGMPRequest msg) = 0;//yen
...
public:
  ...
  virtual void SendRrcIGMPRequest (RrcIGMPRequest msg);//yen
...
template <class C>
void 
MemberLteUeRrcSapUser<C>::SendRrcIGMPRequest (RrcIGMPRequest msg)
{
  m_owner->DoSendRrcIGMPRequest (msg);
}
...
public:
  ...
  virtual void RecvRrcIGMPRequest (uint16_t rnti, RrcIGMPRequest msg);//yen
...
template <class C>
void 
MemberLteEnbRrcSapProvider<C>::RecvRrcIGMPRequest (uint16_t rnti, RrcIGMPRequest msg)
{
  Simulator::ScheduleNow (&C::DoRecvRrcIGMPRequest, m_owner, rnti, msg);
}
