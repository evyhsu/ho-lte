...
//yen  
  /**
  * Create a LteRadioBearerTag with the given RNTI, LC id and layer and multicastgroup
  */
  LteRadioBearerTag (uint16_t  rnti, uint8_t lcId, uint8_t layer, uint16_t multicastgroup);
  /**
...
//yen
  /**
  * Set the multicastgroup id to the given value.
  *
  * @param multicastgroup the value of the multicastgroup to set
  */
...
//yen
  uint16_t GetMulticastGroup (void) const;
