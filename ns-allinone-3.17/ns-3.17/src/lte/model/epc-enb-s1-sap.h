...
//yen add igmp
  ...
  virtual void IGMPReport (IGMPReportParameters params) = 0;
  /** 
...
public:
  ...
  virtual void IGMPReport (IGMPReportParameters params);//YEN
...
//YEN
template <class C>
void MemberEpcEnbS1SapProvider<C>::IGMPReport (IGMPReportParameters params)
{
  m_owner->DoIGMPReport (params);
}
