...
//yen
  LteUeNetDevice (Ptr<Node> node, Ptr<LteUePhy> phy, Ptr<LteUeMac> mac, Ptr<LteUeRrc> rrc, Ptr<EpcUeNas> nas, uint64_t imsi, uint16_t multicastgroup);
  ...
  Ipv4Address SetUeAddress (Ipv4Address ueAddr);//YEN
  Ipv4Address SetRemoteAddress (Ipv4Address ueAddr);//YEN
