...
private:
  ...
  virtual void SetIgmpreceived (bool igmpreceived);//yen
  virtual bool GetIgmpreceived (void) const;//yen
...
//yen add
  ...
  void
  SendIGMPReply (Ptr<Packet> packet,
  ...
  void
  SetOutputDeviceyen (Ptr<NetDevice> outputDevice);
 
  Ptr<NetDevice>
  GetOutputDeviceyen (void) const;

  void
  SwitchToIgmpState (IgmpState newState);
  ...
  bool m_ipForward;
  bool m_weakEsModel;
  bool m_igmpreceived;//yen
  Ipv4Address m_ueAddr;//yen
  Ipv4Address m_remoteAddr;//yen
  Ptr<NetDevice> m_outputDevice;//yen
